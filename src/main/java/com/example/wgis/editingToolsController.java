 ...
 */
public class editingToolsController {
     ...
     * @param String currentBuilding and newBuildName for the building name.
     */
     ...
     * @param String buildName for the building name.
     */
     ...
     * @param String for the point of interest's name.
     */
     ...
     * @param string for the building name.
     * @return i the index of the building.
     */
